...
if (isset($league_id) && !empty($league_id) && isset($local_team) && !empty($local_team) && isset($visitor_team) && !empty($visitor_team) && isset($match_id) && !empty($match_id) && isset($local_id) && !empty($local_id) && isset($visitor_id) && !empty($visitor_id)) {
