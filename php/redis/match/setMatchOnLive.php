...
if (isset($match_date) && !empty($match_date) && isset($league_id) && !empty($league_id) && isset($local_team) && !empty($local_team) && isset($visitor_team) && !empty($visitor_team) && isset($match_id) && !empty($match_id) && isset($local_id) && !empty($local_id) && isset($visitor_id) && !empty($visitor_id)) {
    $redis->set('league_id', $league_id);
    ...
    $redis->set('match_date', $match_date);
